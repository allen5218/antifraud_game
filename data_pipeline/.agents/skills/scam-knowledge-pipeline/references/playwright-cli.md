...
This reference was merged from the former standalone `playwright-cli` skill. It is now part of `scam-knowledge-pipeline`; use it only when `references/playwright-crawling.md` routes here or when browser automation details are required.
...
* **Running and Debugging Playwright tests** [playwright-cli-playwright-tests.md](playwright-cli-playwright-tests.md)
...
* **Spec-driven testing (plan / generate / heal)** [playwright-cli-spec-driven-testing.md](playwright-cli-spec-driven-testing.md)
...
* **Inspecting element attributes** [playwright-cli-element-attributes.md](playwright-cli-element-attributes.md)
