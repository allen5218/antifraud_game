...
All three lean on the same mechanic: run `npx playwright test --debug=cli` in the background, then `playwright-cli attach tw-XXXX` to drive the paused page interactively. See [playwright-cli-playwright-tests.md](playwright-cli-playwright-tests.md) for the debug/attach mechanics and [playwright-cli-test-generation.md](playwright-cli-test-generation.md) for how every `playwright-cli` action emits Playwright TypeScript.
...
Every action prints the equivalent Playwright TypeScript (see [playwright-cli-test-generation.md](playwright-cli-test-generation.md)):
...
For each `- expect:` bullet, add an explicit assertion. See [playwright-cli-test-generation.md](playwright-cli-test-generation.md) for details.
...
| For... | See |
|---|---|
| `--debug=cli` / attach mechanics | [playwright-cli-playwright-tests.md](playwright-cli-playwright-tests.md) |
| How `playwright-cli` actions become TS | [playwright-cli-test-generation.md](playwright-cli-test-generation.md) |
| Mocking requests during exploration/generation | [playwright-cli-request-mocking.md](playwright-cli-request-mocking.md) |
| Managing the CLI browser session | [playwright-cli-session-management.md](playwright-cli-session-management.md) |
